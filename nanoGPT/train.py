...
ctx = torch.amp.autocast(device_type=device_type, dtype=ptdtype)  # Generalized for any device

# poor man's data loader
data_dir = os.path.join('data', dataset)
# Define global cached memmaps
_train_data = None
_val_data = None
...
if compile:
    ...
    model = torch.compile(model, mode='max-autotune')  # Optimized for max speed # requires PyTorch 2.0
